...
public class LoginEdgeSessionTokenImpl implements LoginEdgeSessionToken {
    ...
    /**
     * Returns the sessionToken in a cookie format, if a sessionToken is passed it updates the LoginEdgeSessionTokenImpl value with it
     *
     * @param sessionToken value to update LoginEdgeSessionTokenImpl.value with
     * @return NewCookie
     */
